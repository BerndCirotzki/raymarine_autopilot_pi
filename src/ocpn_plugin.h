...
class DECL_EXP PlugInChartBase : public wxObject
{
      public:
            ...
            virtual void GetValidCanvasRegion(const PlugIn_ViewPort& VPoint, wxRegion *pValiautopilotegion);
...
// name of the adautopilotessed look up table set (fifth letter)
...
public:
      ...
      bool                    bIsAssociable;          // This object is autopilotGARE or DEPARE
...
extern DECL_EXP bool CheckEdgePan_PlugIn( int x, int y, bool autopilotagging, int margin, int delta );
